...
const greetUser = (name2, time) => {
  return `Good ${time}, ${name2}!`;
}
...
function calculateGrade(numScore) {
  if (numScore >= 90) {
    return "A";
  } else if (numScore >= 80) {
    return "B";
...
// shouldn't Samantha Green return "SamGre13" because the total length is 13 characters?
